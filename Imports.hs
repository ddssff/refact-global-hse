...
cleanImports :: (MonadIO m, MonadBaseControl IO m) => GHCOpts -> [ModuleInfo SrcSpanInfo] -> m ()
cleanImports _ [] = trace ("cleanImports - no modules") (pure ())
cleanImports opts info =
